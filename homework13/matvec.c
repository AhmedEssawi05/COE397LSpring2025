 ...
 ****************************************************************/
 ...
 /**** your code here ****/
      ...
      PetscCall(VecGetArray(y, &localdata));
      PetscCall(VecPlaceArray(localvec, localdata));
      PetscCall(VecNorm(localvec, NORM_1, &norm));
      PetscCall(VecResetArray(localvec));
      PetscCall(VecRestoreArray(y, &localdata));
     /*
