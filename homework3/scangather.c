...
int main(int argc,char **argv) {
  ...
  {
    int temp;
    MPI_Exscan(&my_number_of_elements, &temp, 1, MPI_INT, MPI_SUM, comm);
    if (procno==0)
      my_first_index = 0;
    else
      my_first_index = temp;
  ...
  MPI_Gather
    (
  /**** your code here ****/
      &my_number_of_elements, 1, MPI_INT,
      size_buffer, 1, MPI_INT,
      0, comm
    );
  ...
  MPI_Gather
    (
  /**** your code here ****/
      &my_first_index, 1, MPI_INT,
      displ_buffer, 1, MPI_INT,
      0, comm
    );
  ...
  /**** your code here ****/
      ...
      gather_buffer, size_buffer, displ_buffer, MPI_INT,
      0, comm
    );
